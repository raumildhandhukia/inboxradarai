      ...
      <div className="mb-24 md:px-20 2xl:px-56">
        ...
        <div className="mt-10 px-5 ">
          ...
          <p className="text-lg mt-5 md:text-xl leading-relaxed text-left">
            ...
            email management process. Our application integrates seamlessly with
            your Gmail inbox, utilizing advanced Large Language Model (LLM)
            technology, Gemini, to intercept, process, and categorize your
          ...
          <p className="mt-5 text-lg md:text-xl leading-relaxed text-left">
            ...
            dashboard and detailed charts, you gain valuable insights into your
            email patterns, helping you stay organized and informed.
          </p>
          <p className="mt-5 text-lg md:text-xl leading-relaxed text-left">
