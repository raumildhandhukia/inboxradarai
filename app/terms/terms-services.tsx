...
const TermsServices = () => {
  return (
    <div className="tiptap ProseMirror prose max-w-none focus:outline-none">
      <p>
      ...
      <p>
        <strong>Last updated</strong> <strong>August 29, 2024</strong>
      </p>
      <p>
        <br className="ProseMirror-trailingBreak" />
      </p>
      ...
      <p>
        We are InboxRadarAI ( &quot;<strong>Company</strong>,&quot; &quot;
        <strong>we</strong>,&quot; &quot;<strong>us</strong>,&quot; &quot;
        <strong>our</strong>&quot; ) , a company registered in Arizona , United
        States at 1023 E University Dr , Tempe , AZ 85288 .
      </p>
      <p>
        We operate the website <strong>https://www.inboxradarai.com</strong>
      ...
      <p>
        You can contact us by phone at (+1)6023451699 , email at
        inboxradarai@gmail.com , or by mail to 1023 E University Dr , Tempe , AZ
        85288 , United States .
      </p>
      <p>
        <br className="ProseMirror-trailingBreak" />
      ...
      <p>
        ...
        <strong>you</strong>&quot; ), and InboxRadarAI , concerning your access
      ...
      <p>
        ...
        address your request to: inboxradarai@gmail.com. If we ever grant you
      ...
      <p>current or future use of the Services (or any portion thereof).</p>
      <p>
        <br className="ProseMirror-trailingBreak" />
      </p>
      <p>
      ...
      <p>
        ...
        Policy:<strong> http://www.inboxradarai.com/privacy</strong>. By using
      ...
      <p>
        ...
        construed in accordance with the laws of the State of Arizona applicable
      ...
      <p>
        ...
        for at least ninety (90) days before initiating arbitration. Such
      ...
      <p>
        ...
        <strong>American Arbitration Association (AAA) website</strong>. Your
        ...
        applicable law, the arbitration will take place in Maricopa, Arizona.
      ...
      <p>
        ...
        courts located in Maricopa, Arizona, and the Parties hereby consent to,
      ...
      <p>
        <strong>InboxRadarAI</strong>
      </p>
      <p>
        <strong>1023 E University Dr</strong>
      </p>
      <p>
        <strong>Tempe , AZ 85288</strong>
      </p>
      <p>
        <strong>United States</strong>
      </p>
      <p>
        <strong>Phone: (+1)6023451699</strong>
      </p>
      <p>
        <strong>inboxradarai@gmail.com</strong>
      </p>
    </div>
  );
};
