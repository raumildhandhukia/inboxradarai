...
const FlyoutLink = ({ children, href }: FlyoutLink) => {
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-32 -top-[220px] bg-white text-black"
          >
            ...
            <div className="w-64 bg-white rounded-lg p-6 shadow-xl h-[200px] flex flex-col justify-evenly border-2">
              <Button
                variant="hacker"
                onClick={() => {
